...
BBS_ln_scale2 <- BBS_ln_scale %>%
  ...
  summarise(sum_abundance = sum(SUM_ROUTE_ABUNDANCE),
...
BBS_ln_scale3$NEONIC <- factor(BBS_ln_scale3$NEONIC,
                                  levels = c("pesticide", "neonic"))
BBS_ln_scale3$NEONIC <- relevel(BBS_ln_scale3$NEONIC, ref = "pesticide")
...
scale_glmer <- glmer(data = BBS_ln_scale3,
                     sum_abundance ~ scale_scale_:NEONIC +
                       ...
                       (1|ROUTE_FAC) + (1|COMMON_NAME) + (1|obs), family = poisson)
summary(scale_glmer)
...
scale_glmer3 <- glmer(data = BBS_ln_scale3,
                     sum_abundance ~ scale_scale_:NEONIC +
                       ...
                       year_scaled +
                       DIET2 + DIET2:scale_scale_:NEONIC +
                       (COMMON_NAME|ROUTE_FAC) , family = poisson)
