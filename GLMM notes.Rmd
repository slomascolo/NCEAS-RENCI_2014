...
## Response variables
Suggest separate analyses for the following. 
...
Another way of trying to nabble out the yield-vs-intensity could be to add a multiplier for fertilised land to the 'intensity' scale (easy enough, I think it's in NASS)
